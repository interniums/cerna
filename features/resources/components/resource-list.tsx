...
function ResourceRow({ r }: { r: Resource }) {
  ...
  return (
    <Card className="cerna-hover-card group h-full min-h-[112px] max-w-full min-w-0 p-0 motion-reduce:transition-none">
      <div className="flex h-full max-w-full min-w-0 items-stretch gap-0">
        ...
        >
          <div className="flex h-full min-w-0 items-center gap-3">
            <div className="flex size-10 shrink-0 self-center items-center justify-center overflow-hidden rounded-md border bg-muted">
...
export function ResourceList({ resources }: { resources: Resource[] }) {
  ...
  return (
    <div className="grid max-w-full min-w-0 auto-rows-[1fr] gap-3">
      {resources.map((r) => (
