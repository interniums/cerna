      ...
      <div className="relative flex-1 min-h-0">
        <ScrollYFade className="h-full" viewportClassName="pr-4 pb-16">
          <div className="pt-4 pb-4">
            <PageViewTracker workflowId={workflowId} name="view_command_center" />
            <CommandCenterClient workflowId={workflowId} openTasks={openTasks} doneTasks={doneTasks} initialFocusTaskId={focusTaskId} />
          </div>
        </ScrollYFade>
      </div>
    </div>
